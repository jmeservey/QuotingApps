...
namespace ClassLibrary.Models
{
    public class QuoteModel
    {
        ...
        public string SMCContactName { get; set; }
        public string SMCContactPhone { get; set; }
        public string SMCContactEmail { get; set; }
        ...
        public QuoteModel()
        {
            ...
            QuoteNumber = "01-23550N-001";
            RFQDescription = "5429-Cap";
            QuoteRevision = "1";
            ...
            Parts.Add(new PartModel() { ItemNumber = 1, Description = "PIBA, 24 mm Bottle Well", DrawingNumber = "NA", RevisionNumber = "NA", Material = "Lustran 348-000000 Natural", Packaging = "Bulk", Cavitation = 2, MoldBase = "Dedicated Base # 2", Warranty = "100,000 Shots, 2 Yrs", MoldPrice = 36000, MoldLeadTime = 5, ValidationPrice = 45000});
